...
<div class="wrapper">
    ...
    <nav id="sidebar">
        <div class="sidebar-header" style=""><a href='index.php'>
                <img src='img/zain1.png' class='img-responsive' style='width:85%;    '></a>
        ...
        <p style="text-align: center; color: #8F539F; font-size: larger"><?php echo $credits[1]; ?>
        </p>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#nav > li').on('click', function () {
                    // alert('dsda');
                    $('.image--cover').css('border', '3px solid #8F539F');

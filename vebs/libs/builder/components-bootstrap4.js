...
["html/container", "html/gridrow", "html/heading", "html/image", "html/jumbotron", "html/listgroup", 
"html/hr", "html/form",  "html/table", "html/div" ];
...
Vvveb.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img style="width: 100%;" src="'+ Vvveb.baseUrl + '">',
    afterDrop: function (node)
	{
        Vvveb.baseUrl=Vvveb.baseUrl.replace("http://localhost", "");
		node.attr("src",Vvveb.baseUrl );
		return node;
	},
...
Vvveb.Components.extend("_base", "html/form", {
    ...
    name: "Form",
    html: '<form class="form-group" ><div class="form-group">'+
    '<label id="lbl1">Text 1</label><input type="text" id="txt1" class="form-control">'+
    '<label id="lbl2">Text 2</label><input type="text" id="txt2" class="form-control">'+
    '<label id="lbl3">Text 3</label><input type="text" id="txt3" class="form-control">'+
    '<label id="lbl4">Text 4</label><input type="text" id="txt4" class="form-control">'+
    '<label id="lbl5">Text 5</label><textarea id="txtarea1" class="form-control"></textarea>'+
    '<input type="submit" id="submit1" Value="Submit" class="btn btn-success">'+
    '</div></div></form>',
    properties: [{
        name: "Style",
        key: "style",
...
Vvveb.Components.extend("_base", "html/div", {
    ...
    html: '<div style="margin-top: 45px;"></div>',
    name: "Spacer"
});

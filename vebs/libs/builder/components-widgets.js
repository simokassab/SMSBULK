...
Vvveb.ComponentsGroup['Widgets'] = ["widgets/googlemaps", "widgets/video",  "widgets/facebookpage", "widgets/instagram", "widgets/twitter", 'widgets/socialplugin'];
...
Vvveb.Components.extend("_base", "widgets/googlemaps", {
    ...
    html: '<div data-component-maps style="min-height:240px;min-width:240px;position:relative"><iframe frameborder="0" '+
   ' src="https://maps.google.com/maps?&z=1&t=q&output=embed" width="100" height="100"'+ 
   'style="width:100%;height:100%;position:absolute;left:0px;pointer-events:none"></iframe></div>',
...
Vvveb.Components.extend("_base", "widgets/video", {
    ...
    html: '<div data-component-video style="min-height:340px;min-width:340px;position:relative; text-align: center;">' +
          '<iframe frameborder="0" src="https://www.youtube.com/embed/-stFvGmg1A8" style="width:90%;height:100%;position:absolute;left:0px;pointer-events:none"></iframe>' +
          '</div>',
	...
	onChange: function (node, property, value)
	{
		...
		//if (property.key == "t")
		{
			switch (this.t)
			{
				...
				$("#right-panel [data-key=url]").hide();
				newnode = $('<div data-component-video><iframe src="https://www.youtube.com/embed/' + this.video_id + '?&amp;autoplay=' + this.autoplay + '&amp;controls=' +
                    this.controls + '&amp;loop=' + this.loop + '" allowfullscreen="true" style="height: 240px; width: 90%;" frameborder="0"></iframe></div>');
				break;
				case 'v':
				$("#right-panel [data-key=video_id]").show();
				$("#right-panel [data-key=url]").hide();
				newnode = $('<div data-component-video><iframe src="https://player.vimeo.com/video/' + this.video_id + '?&amp;autoplay=' + this.autoplay + '&amp;controls=' +
                    this.controls + '&amp;loop=' + this.loop + '" allowfullscreen="true" style="height: 240px; width: 100%;" frameborder="0"></iframe></div>');
				break;
				case 'h':
...
Vvveb.Components.extend("_base", "widgets/instagram", {
    ...
    html: '<div align=center data-component-instagram>\
			<blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/tsxp1hhQTG/"'+
...
Vvveb.Components.extend("_base", "widgets/twitter", {
    ...
    html: '<div data-component-twitter><a class="twitter-timeline" href="https://twitter.com/SIMOKASAB?ref_src=twsrc%5Etfw">Tweets by SIMOKASAB</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>\
...
Vvveb.Components.extend("_base", "widgets/facebookpage", {
    ...
    html: '<div data-component-facebookpage><div class="fb-page" data-href="https://www.facebook.com/facebook" data-appId="100526183620976" data-tabs="timeline" data-small-header="true" \
...
Vvveb.Components.extend("_base", "widgets/socialplugin", {
    name: "social",
    attributes: ["data-component-socialplugin"],
    image: "icons/facebook.svg",
    dropHtml: '<img src="' + Vvveb.baseUrl + 'icons/facebook.png">',
    html: '<div data-component-socialplugin>' +
    '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">' +
    '<style> .fa {padding: 20px; margin-right: 25px;    font-size: 30px;    width: 70px; height: 70px;  text-align: center;    text-decoration: none;}' +
    '.fa:hover {    opacity: 0.7;}' +
    '.fa-facebook {    background: #3B5998;    color: white;}' +
    '.fa-twitter {    background: #55ACEE;    color: white;}</style>' +
    '<a href="#" class="fa fa-facebook">' +
    '</a><a href="#" class="fa fa-twitter"></a></div>'
});

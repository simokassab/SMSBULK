    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col col-sm-4" style="margin-left: 8%;">
                <div class="campdetails" style=" margin-top: 30%; background-color: white; min-height: 300px; border-radius: 1%; border: 1px solid #8F539F; ">
                    <p style="color: #7D7D7D; font-size: 1.3vw; margin: 2% 0 5% 8%;"><i class="fa fa-bullhorn" style="margin-right: 4%; color: #8F539F;"></i> Campaign Name:
                        <u style="color: #8F539F;font-size: 1vw; ">
                        <?php echo $camp[1]; ?></u>
                    </p><hr>
                    <?php
                        if($camp[2]=='advanced'){
                    ?>
                    <p style="color: #7D7D7D; font-size: 1.3vw; margin: 2% 0 5% 8%;"><i class="fas fa-cog" style="margin-right: 4%; color: #8F539F;"></i> Campaign Sending Type:
                        <u style="color: #8F539F;font-size: 1vw; margin-left: 35%; margin-top: 3%;">
                            <?php echo $camp[3]; ?></u>
                    </p><hr>
                    <?php } ?>
                    <p style="color: #7D7D7D; font-size: 1.3vw; margin: 2% 0 1% 8%; "><i class="fa fa-edit" style="margin-right: 4%; color: #8F539F;"></i>SMS Body:
                    </p>
                    <span style="color: #8F539F; border: 1px solid #F2F2F2; margin: 0% 0 0 19%;">
                        <?php
                        if($camp[2]=='social'){
                    ...
                    <p style="color: #7D7D7D; font-size: 1.3vw; margin: 2% 0 5% 8%;"><i class="fa fa-users" style="margin-right: 4%; color: #8F539F;"></i>Recipient Groups:<br>
                        <span style="color: #8F539F;font-size: 1vw; margin-left: 25%; margin-top: 5%;">
                            <?php
                            $p="";
                            $grs=$camp[6];
                            $gr=explode(",", $grs);
            ...
            <?php
                if($camp[2]=='regular'){
                    ...
                    echo '<h1 style="color: #8F539F;">Regular Campaign</h1>';
                    echo '</div>';
                }
                else {
            ?>
        ...
        <?php
            if(($camp[2]!='regular') ) {
                ?> <div class="row" style="text-align: center;margin-left: 7%;">
                    <div class="col col-md-5" style="border:2px solid #8F539F; background-color: white; margin: 1%; border-radius: 3%;">
                ...
                <div class="row ">
                    ...
                    <div class="col col-sm-2 nbvisitor">
                        ...
                        <hr>
                        <p id='visit_day' style="color: #8F539F; font-size: 58px; text-align: center"></p>
                        <hr>
                    ...
                    <div class="row" style=" margin-top: 4% ;padding: 20px; text-align: center;  border:2px solid #0881BD; background-color: white;  border-radius: 3%;">
                        <div class="col col-md-4" style="border-right: 1px solid red;">
                            <div class="row">
                                <div class="col col-sm-6">
                                    <h6>Facebook</h6>
                                    <hr>
                                    <p id='facebookvisitors' style="color: #8F539F; font-size: 58px; text-align: center"><?php echo $fcbk; ?></p>
                                    <hr>
                                </div>
                                <div class="col col-sm-6">
                                    <h6>Twitter</h6>
                                    <hr>
                                    <p id='twittervisitors' style="color: #8F539F; font-size: 58px; text-align: center"><?php echo $twitter; ?></p>
                                    <hr>
                                </div>
                            </div>
                        </div>
                        <div class="col col-md-4" style="border-right: 1px solid red;">
                            <div class="row">
                                <div class="col col-sm-6">
                                    <h6>Youtube</h6>
                                    <hr>
                                    <p id='ytvisitors' style="color: #8F539F; font-size: 58px; text-align: center"><?php echo $yt; ?></p>
                                    <hr>
                                </div>
                                <div class="col col-sm-6">
                                    <h6>Youtube / Ended</h6>
                                    <hr>
                                    <p id='ytendedvisitors' style="color: #8F539F; font-size: 58px; text-align: center"><?php echo $ytended; ?></p>
                                    <hr>
                                </div>
                            </div>
                        </div>
                        <div class="col col-md-4" style="border-right: 1px solid red;">
                            <div >
                                <h6>Click to Call</h6>
                                <hr>
                                <p id='clicktocallvisitors' style="color: #8F539F; font-size: 58px; text-align: center"><?php echo $clicktocall; ?></p>
                                <hr>
                            </div>
                        </div>
                    </div>

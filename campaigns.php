                        ...
                        <div id="list">
                            ...
                            <div id="step-3" style="text-align: center;">
                                ...
                                <div id="form-step-2" role="form" data-toggle="validator">
                                    ...
                                    <br>
                                    <span id="count" style="color: #8F539F; font-weight: bolder;"></span>
                                    <br>
                        ...
                        <?php foreach ($viewcamp as $cmp) {
                            ...
                            <tr id='<?php echo $cmp['id']; ?>' class="campidtable">
                                ...
                                if ($cmp['CMP_STATUS'] == 'SENT') {
                                    ...
                                    echo '<td style="color: #8F539F; font-weight: bolder">' . $cmp['CMP_STATUS'] . '</td>';
                                } else {
